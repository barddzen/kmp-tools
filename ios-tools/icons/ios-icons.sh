#!/bin/bash
# Generate iOS icons from a single source image
# Run from any iOS Xcode project directory
#
# Usage: ios-icons.sh <source_image.png>
...
if [ -z "$1" ]; then
    ...
    echo ""
    echo "Usage: ios-icons.sh <source_image.png>"
    echo ""
    echo "Example:"
    echo "  ios-icons.sh assets/icons/my-icon.png"
    exit 1
fi
