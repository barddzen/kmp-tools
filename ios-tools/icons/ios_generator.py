#!/usr/bin/env python3
"""
iOS icon generation for iOS-only Xcode projects
...
class iOSIconGenerator:
    """Generates iOS icon assets for iOS-only Xcode projects"""

    def __init__(self, assets_path):
        """
        Initialize generator with path to Assets.xcassets

        Args:
            assets_path: Path to Assets.xcassets folder (will be created if needed)
        """
        self.output_path = Path(assets_path)
