#!/usr/bin/env python3
"""
Claude Vision API integration for iOS screenshot analysis
"""
...
class VisionAnalyzer:
    ...
    def analyze_and_rank_screenshots(self, image_paths, platform, device_type):
        ...
        Args:
            ...
            platform: 'ios_iphone' or 'ios_ipad'
        ...
        prompt = f"""You are an App Store optimization expert analyzing screenshots for an iOS app.
...
[
  ...
  ...
        ...
        try:
            ...
            for idx, img_path in enumerate(sorted(image_paths), 1):
                fallback.append({
                    ...
                    'subtitle': 'Your new favorite iOS experience',
    ...
    def analyze_screenshot(self, image_path, platform, device_type):
        ...
        # Create prompt
        prompt = f"""Analyze this iOS app screenshot and generate compelling App Store marketing copy.
...
Your task:
1. Identify what feature/screen is shown
...
{{
  ...
  "confidence": 0.95
    ...
    def _get_platform_context(self, platform, device_type):
        ...
        return contexts.get(platform, contexts['ios_iphone'])
